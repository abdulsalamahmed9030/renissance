        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <img
              src="/logo.png"
              alt="Meridian Events"
              className="h-22 md:h-26 mb-4 block object-contain"
            />
            ...
            <p className="text-background/60 text-sm leading-relaxed max-w-md">
              ...
              meetings, conferences, and special events that reflect each
              client’s mission while delivering meaningful brand experiences.
            </p>
          </div>
